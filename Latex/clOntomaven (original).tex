...
Define $R_\ttl(\corp)$ for any CL2 corpus $\corp$ to be the corpus of all CL2 texts such that each text in $R_\ttl(\corp)$ is obtained from the substitution in some text of $\corp$ of one occurrence of an $N$ importation with the text $\ttl(N)$.  That is,
\begin{equation*}
